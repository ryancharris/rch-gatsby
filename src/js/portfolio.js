export const portfolioPieces = [
...

  {
    ...
    description:
      "Inspired by Google's Material Design and built using the Bootstrap framework, this is the first iteration of the site you're currently on.",
    link: "https://github.com/ryancharris/ryancharris.github.io",
  },
  {
    title: "Tic Tac Toe",
    description:
